...
from .serializers import (
    UserSerializer, MapSerializer, WeaponSerializer, MatchSerializer,
    MatchSerializerDetail, UserMatchStatCreateSerializer, 
    UserMatchStatDetailSerializer, WeaponStatCreateSerializer,
    WeaponStatViewSerializer, UserStatsSummarySerializer
)
...
class WeaponModelTests(TestCase):
    ...
    def test_weapon_str_representation(self):
        weapon = Weapon.objects.create(
            name='AWP Dragons Lore',
            weapon_type=Weapon.WeaponType.SNIPER
        )
    ...
    def test_all_weapon_types(self):
        for weapon_type_code, weapon_type_name in Weapon.WeaponType.choices:
            weapon = Weapon.objects.create(
                name=f'Test {weapon_type_name}',
                weapon_type=weapon_type_code
            )
...
class WeaponStatModelTests(TestCase):
    ...
    def test_weapon_stat_multiple_weapons(self):
        ...
        m4 = Weapon.objects.create(
            name='M4A1',
            weapon_type=Weapon.WeaponType.RIFLE
        )
        m4_stat = WeaponStat.objects.create(
            stat=self.stat,
            weapon=m4,
            kills=10
        )

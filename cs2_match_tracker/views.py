from .models import Map, Weapon, User, Match, WeaponStat, UserMatchStat
from .serializers import (
    MapSerializer, UserRegisterSerializer, WeaponSerializer, UserSerializer, 
    UserStatsSummarySerializer, MatchSerializer, MatchSerializerDetail,
    UserMatchStatCreateSerializer, UserMatchStatDetailSerializer, 
    WeaponStatCreateSerializer, WeaponStatViewSerializer
)
...
class UserMatchStatViewSet(viewsets.ModelViewSet):
    queryset = UserMatchStat.objects.select_related('user', 'match').prefetch_related('weapon_stats__weapon')
    permission_classes = [IsAuthenticated]
